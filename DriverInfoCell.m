...
- (id)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.driverStatusLabel = [[UILabel alloc] initWithFrame:CGRectMake(160, 8, 40, 14)];
        ...
        self.starsProcess = [[DPMeterView alloc] initWithFrame:CGRectMake(220, 8, 80, 14)];
        ...
        self.nativePlaceLabel = [[UILabel alloc] initWithFrame:CGRectMake(260, 46, 50, 12)];
